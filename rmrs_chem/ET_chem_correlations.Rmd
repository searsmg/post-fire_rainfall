...
ggplot(chem, aes(Date, NO3, fill=site)) + geom_col(position='dodge', width=15) +
  scale_x_date(date_labels="%m-%y",date_breaks  ="1 month") +
  facet_wrap(~year, scales='free_x')

# look at chemistry data
ggplot(chem, aes(Date, TDN, fill=site)) + geom_col(position='dodge', width=15) +
  scale_x_date(date_labels="%m-%y",date_breaks  ="1 month") +
  facet_wrap(~year, scales='free_x')

# look at chemistry data
ggplot(chem, aes(Date, DOC, fill=site)) + geom_col(position='dodge', width=15) +
  scale_x_date(date_labels="%m-%y",date_breaks  ="1 month") +
  facet_wrap(~year, scales='free_x')

# look at chemistry data
ggplot(chem, aes(Date, NH4, fill=site)) + geom_col(position='dodge', width=15) +
  scale_x_date(date_labels="%m-%y",date_breaks  ="1 month") +
  facet_wrap(~year, scales='free_x')

# look at chemistry data
ggplot(chem, aes(Date, DON, fill=site)) + geom_col(position='dodge', width=15) +
  scale_x_date(date_labels="%m-%y",date_breaks  ="1 month") +
  facet_wrap(~year, scales='free_x')

# look at chemistry data
ggplot(chem, aes(Date, Ca, fill=site)) + geom_col(position='dodge', width=15) +
  scale_x_date(date_labels="%m-%y",date_breaks  ="1 month") +
  facet_wrap(~year, scales='free_x')

ggplot(chem, aes(Date, SO4, fill=site)) + geom_col(position='dodge', width=15) +
  scale_x_date(date_labels="%m-%y",date_breaks  ="1 month") +
  facet_wrap(~year, scales='free_x')

ggplot(chem, aes(Date, K, fill=site)) + geom_col(position='dodge', width=15) +
  scale_x_date(date_labels="%m-%y",date_breaks  ="1 month") +
  facet_wrap(~year, scales='free_x')
