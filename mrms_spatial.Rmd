...
points <- st_as_sf(hads, coords = c("longitude_d", "latitude_d"), crs = 4326)
...
save.image("/Users/megansears/Documents/Repos/post-fire_rainfall/bbox_2fires/stack_2023_fil.RData")
rm(list = ls())
...
save.image("/Users/megansears/Documents/Repos/post-fire_rainfall/bbox_2fires/stack_2022_fil.RData")
rm(list = ls())
...
save.image("/Users/megansears/Documents/Repos/post-fire_rainfall/bbox_2fires/stack_2021_fil.RData")
