...
# cp 22
mi60_p10_22_rast <- rast('./data/mrms_data/bbox_2fires/mrms2022_mi60_p10.tif')
...
# cp 21
mi60_p10_21_rast <- rast('./data/mrms_data/bbox_2fires/mrms2021_mi60_p10.tif')
...
dem_p10over <- dem_p10over %>%
  mutate(elev_m = USGS_13_n41w106_20230314) %>%
  mutate(
    elevation_bin = cut(
      elev_m, 
