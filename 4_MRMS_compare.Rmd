...
#setwd("./data/mrms_data/2min_2021") # update below (filenames) so we aren't 
...
Ran the above for all the groups (2021, 2022, 2022, 2023 (vpn), and 2023 extra (vpn)) - extra no longer applies
...
above no longer applies since using bbox 2 fires
...
write_csv(pixel_intens, './data/mrms_data/pixel_tb_intens.csv')
