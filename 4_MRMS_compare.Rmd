...
plot2 <- ggplot(comp_all, 
                aes(x = MI60_mmhr.y)) + 
  geom_density(alpha = 1, aes(fill = "MI60_mmhr.y")) +  # First density plot
  geom_density(data = comp_all, aes(x = MI60_mmhr.x, fill = "MI60_mmhr.x"), alpha = 0.8) +  # Second density plot
  facet_wrap(~fire, labeller = labeller(fire = new_facet_titles)) 
