...
comp_etf <- comp_intens %>%
  ...
  mutate(
    condition = case_when(
      site == 'hum2' &
        start_time.x > ymd_hms('2022-08-05 00:00:00', tz = 'MST') ~ 'remove',
      site == 'p1' &
        start_time.x > ymd_hms('2022-07-12 00:00:00', tz = 'MST') &
        start_time.x < ymd_hms('2022-07-21 00:00:00', tz = 'MST') ~ 'remove',
      site == 'p1' &
        start_time.x > ymd_hms('2023-07-21 23:50:00', tz = 'MST') ~ 'remove',
      site == 'lpm' &
        start_time.x > ymd_hms('2022-10-1 00:00:00', tz = 'MST') &
        start_time.x < ymd_hms('2023-05-24 10:00:00', tz = 'MST') ~ 'remove',
      TRUE ~ 'keep'
    )
  ) %>%
...
ggplot(filter, aes(y = duration_hr.y, x = duration_hr.x, color = site)) + 
  geom_point() +
  geom_abline(intercept = 0, slope = 1, linetype = "dashed", color = "black") +
  geom_text(x = 12, y = 13, label = "1:1", hjust = 0, vjust = 0, color = "black") +
  ggtitle(paste('cpf duration_hr:', paste("R2 =", round(summary(lm(filter$duration_hr.y ~ filter$duration_hr.x, data = comp_cpf))$r.squared, digits = 2)))) +
  labs(x = 'MRMS', y = 'TB')
...
comp_benn <- comp_intens %>%
  ...
  mutate(
    condition = case_when(
      site == 'me' &
        start_time.x < ymd_hms('2021-07-19 00:00:00', tz = 'MST') ~ 'remove',
      site == 'me' &
        start_time.x > ymd_hms('2021-10-21 00:00:00', tz = 'MST') &
        start_time.x < ymd_hms('2022-06-16 10:00:00', tz = 'MST') ~ 'remove',
      site == 'me' & 
        start_time.x > ymd_hms('2023-09-07 00:00:00', tz = 'MST') ~ 'remove',
      site == 'mm' &
        start_time.x < ymd_hms('2021-09-06 00:00:00', tz = 'MST') ~ 'remove',
      site == 'mm' &
        start_time.x > ymd_hms('2021-10-12 00:00:00', tz = 'MST') &
        start_time.x < ymd_hms('2022-05-22 10:00:00', tz = 'MST') ~ 'remove',
      site == 'mm' &
        start_time.x > ymd_hms('2022-06-07 23:58:00', tz = 'MST') &
        start_time.x < ymd_hms('2022-08-10 10:00:00', tz = 'MST') ~ 'remove',
      site == 'mm' &
        start_time.x > ymd_hms('2022-12-15 00:00:00', tz = 'MST') &
        start_time.x < ymd_hms('2023-06-09 10:00:00', tz = 'MST') ~ 'remove',
      site == 'mm' & 
        start_time.x > ymd_hms('2023-09-28 00:00:00', tz = 'MST') ~ 'remove',
      site == 'mw' &
        start_time.x < ymd_hms('2021-08-20 00:00:00', tz = 'MST') ~ 'remove',
      site == 'mw' &
        start_time.x > ymd_hms('2021-10-15 00:00:00', tz = 'MST') &
        start_time.x < ymd_hms('2022-05-06 10:00:00', tz = 'MST') ~ 'remove',
      site == 'mw' &
        start_time.x > ymd_hms('2022-07-06 00:00:00', tz = 'MST') &
        start_time.x < ymd_hms('2022-08-03 10:00:00', tz = 'MST') ~ 'remove',
      site == 'mw' & 
        start_time.x > ymd_hms('2023-09-19 00:00:00', tz = 'MST') ~ 'remove',
      site == 'ue' &
        start_time.x < ymd_hms('2021-09-06 00:00:00', tz = 'MST') ~ 'remove',
      site == 'ue' &
        start_time.x > ymd_hms('2021-10-12 00:00:00', tz = 'MST') &
        start_time.x < ymd_hms('2022-05-07 10:00:00', tz = 'MST') ~ 'remove',
      site == 'mw' & 
        start_time.x > ymd_hms('2023-05-22 00:00:00', tz = 'MST') ~ 'remove',
      site == 'um' & 
        start_time.x < ymd_hms('2021-07-26 00:00:00', tz = 'MST') ~ 'remove',
      site == 'um' & 
        start_time.x > ymd_hms('2021-08-01 00:00:00', tz = 'MST') ~ 'remove',
      site == 'uw' & 
        start_time.x < ymd_hms('2021-07-19 00:00:00', tz = 'MST') ~ 'remove',
      site == 'um' & 
        start_time.x > ymd_hms('2023-09-07 00:00:00', tz = 'MST') ~ 'remove',
