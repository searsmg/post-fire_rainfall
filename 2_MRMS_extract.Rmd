...
setwd("/Users/megansears/Documents/MRMS/mrms_data/2min_2023")

# Output dir
output_dir <- "/Users/megansears/Documents/MRMS/mrms_data/max_catchment_23/"
...
foreach(fileName = filenames, .packages = c("terra", "lubridate", "dplyr", 'sf')) %dopar% {
  ...
  extract <- terra::zonal(r, catchments_all, fun='max')
...
csv_directory <- "/Users/megansears/Documents/MRMS/mrms_data/max_catchment_23"
...
write.csv(final_data, '/Users/megansears/Documents/MRMS/mrms_data/max_catchment23_2min.csv')
