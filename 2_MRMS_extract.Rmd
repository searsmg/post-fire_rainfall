...
# Output dir
output_dir <- "/Users/megansears/Documents/MRMS/correctedSPR/hillslopes_me_mm/"
...
foreach(fileName = filenames, .packages = c("terra", "lubridate", "dplyr", 'sf')) %dopar% {
  ...
  # Bring in all catchments
  hillslopes_all <- vect('/Users/megansears/Documents/Repos/post-fire_rainfall/data/hillslopes_new/me_mm_hills_updated.shp') %>% # UPDATE BASED ON SITE
    terra::project(., 'EPSG:26913')
  ...
  extract <- terra::zonal(r, hillslopes_all, weighted = T)
  
  extract$catchment <- hillslopes_all$catchment
...
csv_directory <- "/Users/megansears/Documents/MRMS/correctedSPR/hillslopes_me_mm"
...
write.csv(final_data, '/Users/megansears/Documents/MRMS/correctedSPR/hillslopes_me_mm/me_mm_hillslopes_mrms.csv')
