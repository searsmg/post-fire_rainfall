---
title: "Post-fire lag to peak interactions"
author: "Megan Sears"
date: "`r Sys.Date()`"
output:
  html_document:
...
Response variable: lag to peak
The variables are in order largest absolute mean scaled coefficient to smallest
...
#   lag2peak_halfP ~ MI60_mmhr*mean_dnbr +
#     fire +
#     sp_cat +
#     yearCont +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_dnbr.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_dnbr.rds"))
...
mi60levels <- quantile(lag$MI60_mmhr,
                       probs = c(.05, .5, .95), 
                       na.rm = T) # group MI60 into 10, 50, and 90th percentile

terrainLevels <- quantile(lag[[var]], 
                          probs = c(.1, .5, .9), # get groups for catchment var
                          na.rm = T)

newData <- expand.grid(
  var = seq(min(lag[[var]]), max(lag[[var]]), length.out = 50),
...
#include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*terrain_hypso75 +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_hypso75.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_hypso75.rds"))
...
#include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*SP_mean +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_sp.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_sp.rds"))
...
# #include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*terrain_recharge +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_recharge.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_recharge.rds"))
...
# # include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*soil_clay +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_clay.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_clay.rds"))
...
## look by site groupings
sites <- read_csv('./data/final_model_inputs/events_inputs_v2.csv') %>%
  filter(!lag2peak_halfP <= 0) %>% 
  select(site,
         fire,
         lag2peak_halfP,
...
ggplot(site_cat, aes(x=MI60_mmhr,
                  y=lag2peak_halfP,
                  color=bin,
                  fill=bin)) +
  geom_point() +
  facet_wrap(~fire+sp_cat) +
  geom_smooth(method = 'lm') 
...
#include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*soil_ksat +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_ksat.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_ksat.rds"))
...
# include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*lag_pwd +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_pwd.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_pwd.rds"))
...
# include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*terrain_vall_holl +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_valleyhollows.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_valleyhollows.rds"))
...
# # include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*terrain_slope30 +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_slope30.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_slope30.rds"))
...
#include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*terrain_glacial +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_glacial.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_glacial.rds"))
...
#include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*mulch_frac +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_mulch.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_mulch.rds"))
...
#include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*terrain_flowlength +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_flowlength.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_flowlength.rds"))
...
# include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*terrain_elongation +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_elong.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_elong.rds"))
...
# # include linear interactions with static watershed characteristics
# interaction <- stan_glmer(
#   lag2peak_halfP ~ MI60_mmhr*terrain_connec +
#     fire +
#     sp_cat +
#     yearCont +
#     (1 + MI60_mmhr | site_number) +
...
#saveRDS(interaction, "./data/bayes_interaction_outputs/l2p_interaction_connec.rds")
# from the model above - need to update chains and iter 
interaction <- readRDS(here("./data/bayes_interaction_outputs/l2p_interaction_connec.rds"))
