...
# trying this analysis with MAX mrms values going into the catchment intensities
# max for mrms extract and touches = T
# mrms_catch_avg <- read_csv('./data/final/mrms/catchment_mrms_intensities_MAXtouches.csv') %>%
#   mutate(start_time = force_tz(start_time, tzone='MST'),
#          end_time = force_tz(end_time, tzone='MST')) %>%
#   mutate(ID = tolower(ID))

# try this weight mean EXACT (instead of weights, which is approx)
mrms_catch_avg <- read_csv('./data/final/mrms/catchment_mrms_intensities_wmean_exact.csv') %>%
  mutate(start_time = force_tz(start_time, tzone='MST'),
         end_time = force_tz(end_time, tzone='MST')) %>%
  mutate(ID = tolower(ID))
...
```{r}
# load in stage
hum_stage_summ <- read_csv('./data/final/stage_YN_response/hum_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
hum_export <- hum_tb_events %>%
  mutate(site = 'hum')

write_csv(hum_export, './data/final/tb_events/hum_tb_events.csv')
...
hum_cross <- hum_stage_summ %>%
  ...
  left_join(., hum_mrms_events,
            by = 'date') %>%
  mutate(across(event_sum_mm.y:duration_hr.y,
              ~ if_else(is.na(.), 0, .)))

# write.csv(hum_cross,
#            './data/final/stage_YN_response/cross/hum_cross2.csv') # 2 has data where 0.1 was filtered before summed to 10 min

write.csv(hum_cross,
           './data/final/stage_YN_response/cross/hum_cross_wmean.csv') # using mrms max extract for each catchment (touches=T)
...
#           './data/final/stage_YN_response/noflow_rain/hum_tb_noflow2.csv')

write.csv(hum_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/hum_tb_noflow_wmean.csv')
...
#           './data/final/stage_YN_response/noflow_rain/hum_mrms_noflow2.csv')

write.csv(hum_mrms_noflow,
          './data/final/stage_YN_response/noflow_rain/hum_mrms_noflow_wmean.csv')
...
```{r}
p1_stage_summ <- read_csv('./data/final/stage_YN_response/p1_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
p1_export <- p1_tb_events %>%
  mutate(site = 'p1')

write_csv(p1_export, './data/final/tb_events/p1_tb_events.csv')
...
p1_cross <- p1_stage_summ %>%
  ...
  left_join(., p1_mrms_events,
            by = 'date') # no edits needed (no repeat events or missing MRMS)

# write.csv(p1_cross,
#           './data/final/stage_YN_response/cross/p1_cross2.csv')

write.csv(p1_cross,
          './data/final/stage_YN_response/cross/p1_cross_wmean.csv')
...
#           './data/final/stage_YN_response/noflow_rain/p1_tb_noflow2.csv')

write.csv(p1_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/p1_tb_noflow_wmean.csv')
...
#           './data/final/stage_YN_response/noflow_rain/p1_mrms_noflow2.csv')

write.csv(p1_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/p1_mrms_noflow_wmean.csv')
...
hm_stage_summ <- read_csv('./data/final/stage_YN_response/hm_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
write.csv(hm_cross,
          './data/final/stage_YN_response/cross/hm_cross_wmean.csv')
...
write.csv(hm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/hm_tb_noflow_wmean.csv')
...
write.csv(hm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/hm_mrms_noflow_wmean.csv')
...
mpm_stage_summ <- read_csv('./data/final/stage_YN_response/mpm_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
# 
write.csv(mpm_cross,
          './data/final/stage_YN_response/cross/mpm_cross_wmean.csv')

# mpm_cross <- read_csv('./data/final/stage_YN_response/cross/mpm_cross2.csv') %>%
#   mutate(start_time.x = mdy_hm(start_time.x),
#          start_time.y = mdy_hm(start_time.y))
...
write.csv(mpm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mpm_tb_noflow_wmean.csv')
...
write.csv(mpm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mpm_mrms_noflow_wmean.csv')
...
mub_stage_summ <- read_csv('./data/final/stage_YN_response/mub_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
# 
write.csv(mub_cross,
          './data/final/stage_YN_response/cross/mub_cross_wmean.csv')
...
write.csv(mub_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mub_tb_noflow_wmean.csv')
...
write.csv(mub_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mub_mrms_noflow_wmean.csv')
...
mum_stage_summ <- read_csv('./data/final/stage_YN_response/mum_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
write.csv(mum_cross,
          './data/final/stage_YN_response/cross/mum_cross_wmean.csv')
...
write.csv(mum_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mum_tb_noflow_wmean.csv')
...
write.csv(mum_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mum_mrms_noflow_wmean.csv')
...
p2_stage_summ <- read_csv('./data/final/stage_YN_response/p2_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = ymd_hms(datetime_min, tz = "MST"))
...
# 
write.csv(p2_cross,
          './data/final/stage_YN_response/cross/p2_cross_wmean.csv')
...
write.csv(p2_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/p2_tb_noflow_wmean.csv')
...
write.csv(p2_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/p2_mrms_noflow_wmean.csv')
...
Run camera code in camera etf stream events
...
lm_cross <- lm_stage_summ %>%
  mutate(date = date(datetime_min)) %>%
  left_join(., lpm_tb_events,
            by = 'date') %>%
  left_join(., lm_mrms_events,
            by = 'date') %>%
  mutate(across(event_sum_mm.y:duration_hr.y,
              ~ if_else(is.na(.), 0, .)))

write.csv(lm_cross,
          './data/final/stage_YN_response/cross/lm_cross_wmean.csv')
...
write.csv(lm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/lm_tb_noflow_wmean.csv')
...
write.csv(lm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/lm_mrms_noflow_wmean.csv')
...
# 
write.csv(lpm_cross,
          './data/final/stage_YN_response/cross/lpm_cross_wmean.csv')
...
write.csv(lpm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/lpm_tb_noflow_wmean.csv')
...
write.csv(lpm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/lpm_mrms_noflow_wmean.csv')
...
# 
write.csv(lum_cross,
          './data/final/stage_YN_response/cross/lum_cross_wmean.csv')
...
write.csv(lum_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/lum_tb_noflow_wmean.csv')
...
write.csv(lum_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/lum_mrms_noflow_wmean.csv')
...
write.csv(mm_et_cross,
          './data/final/stage_YN_response/cross/mm_et_cross_wmean.csv')
...
write.csv(mm_et_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_et_tb_noflow_wmean.csv')
...
write.csv(mm_et_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_et_mrms_noflow_wmean.csv')
...
bighorn_stage_summ <- read_csv('./data/final/stage_YN_response/bighorn_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
bighorn_mrms_events <- mrms_catch_avg %>%
  filter(ID %in% c('bighorn', 'Bighorn')) %>%
  arrange(start_time) %>%
  mutate(month = month(start_time)) %>%
  filter(month %in% c(6:9),
         year %in% c(2021:2023)) %>%
...
write.csv(bighorn_cross,
          './data/final/stage_YN_response/cross/bighorn_cross_wmean.csv')
...
write.csv(bighorn_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/bighorn_tb_noflow_wmean.csv')
...
write.csv(bighorn_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/bighorn_mrms_noflow_wmean.csv')
...
bl4_stage_summ <- read_csv('./data/final/stage_YN_response/bl4_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
bl4_export <- bl4_tb_events %>%
  mutate(site = 'bl4')

write_csv(bl4_export, './data/final/tb_events/bl4_tb_events.csv')
...
# 
write.csv(bl4_cross,
          './data/final/stage_YN_response/cross/bl4_cross_wmean.csv')

#bl4_cross <- read_csv('./data/final/stage_YN_response/cross/bl4_cross2.csv') 
...
write.csv(bl4_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/bl4_tb_noflow_wmean.csv')
...
write.csv(bl4_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/bl4_mrms_noflow_wmean.csv')
...
dry_stage_summ <- read_csv('./data/final/stage_YN_response/dry_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
dry_cross <- dry_stage_summ %>%
  ...
  left_join(., dry_mrms_events,
            by = 'date') %>%
  # slice(-c(7,8,9,13)) # check
  slice(-c(7,11))
# 
write.csv(dry_cross,
          './data/final/stage_YN_response/cross/dry_cross_wmean.csv')
...
write.csv(dry_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/dry_tb_noflow_wmean.csv')
...
write.csv(dry_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/dry_mrms_noflow_wmean.csv')
...
mich_stage_summ <- read_csv('./data/final/stage_YN_response/mich_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
michigan_export <- mich_tb_events %>%
  mutate(site = 'michigan')

write_csv(michigan_export, './data/final/tb_events/michigan_tb_events.csv')
...
write.csv(mich_cross,
          './data/final/stage_YN_response/cross/mich_cross_wmean.csv')

#mich_cross <- read_csv('./data/final/stage_YN_response/cross/mich_cross2.csv')
...
write.csv(michigan_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/michigan_tb_noflow_wmean.csv')
...
write.csv(michigan_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/michigan_mrms_noflow_wmean.csv')
...
mont_stage_summ <- read_csv('./data/final/stage_YN_response/mont_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
mont_cross <- mont_stage_summ %>%
  ...
  left_join(., mont_mrms_events,
            by = 'date') %>%
  slice(-c(9,11,12)) %>% # FIX THIS MANUALLY bc rain tb even starts on 8/1 in all cross 2
  mutate(start_time.x = if_else(event_id == 90, 
                                NA, start_time.x),
         end_time.x = if_else(event_id == 90, 
                                NA, end_time.x),
         duration_hr.x = if_else(event_id == 90,
                                 0, duration_hr.x),
         event_sum_mm.x = if_else(event_id == 90,
                                 0, event_sum_mm.x),
         MI60_mmhr.x =  if_else(event_id == 90,
                                 0, MI60_mmhr.x),
         MI30_mmhr.x =  if_else(event_id == 90,
                                 0, MI30_mmhr.x))

# 
write.csv(mont_cross,
          './data/final/stage_YN_response/cross/mont_cross_wmean.csv')
...
write.csv(mont_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mont_tb_noflow_wmean.csv')
...
write.csv(mont_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mont_mrms_noflow_wmean.csv')
...
mtcamp_stage_summ <- read_csv('./data/final/stage_YN_response/mtcamp_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
mtcampus_export <- mtc_tb_events %>%
  mutate(site = 'mtcampus')

write_csv(mtcampus_export, './data/final/tb_events/mtcampus_tb_events.csv')
...
write.csv(mtcamp_cross,
          './data/final/stage_YN_response/cross/mtcamp_cross_wmean.csv')
...
write.csv(mtcamp_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mtcamp_tb_noflow_wmean.csv')
...
write.csv(mtcamp_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mtcamp_mrms_noflow_wmean.csv')
...
washout_stage_summ <- read_csv('./data/final/stage_YN_response/washout_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
washout_cross <- washout_stage_summ %>%
  ...
  left_join(., washout_mrms_events,
            by = 'date') %>%
  slice(-c(3)) %>%
   mutate(start_time.y = if_else(event_id == 9,
                                NA, start_time.y),
         end_time.y = if_else(event_id == 9,
                                NA, end_time.y),
         duration_hr.y = if_else(event_id == 9,
                                 0, duration_hr.y),
         event_sum_mm.y = if_else(event_id == 9,
                                 0, event_sum_mm.y),
         MI60_mmhr.y =  if_else(event_id == 9,
                                 0, MI60_mmhr.y),
         MI30_mmhr.y =  if_else(event_id == 9,
                                 0, MI30_mmhr.y))
  

write.csv(washout_cross,
          './data/final/stage_YN_response/cross/washout_cross_wmean.csv')
...
write.csv(washout_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/washout_tb_noflow_wmean.csv')
...
write.csv(washout_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/washout_mrms_noflow_wmean.csv')
...
me_stage_summ <- read_csv('./data/final/stage_YN_response/me_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
me_export <- me_tb_events %>%
  mutate(site = 'me')

write_csv(me_export, './data/final/tb_events/me_tb_events.csv')
...
# 
write.csv(me_cross,
          './data/final/stage_YN_response/cross/me_cross_wmean.csv')
...
write.csv(me_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/me_tb_noflow_wmean.csv')
...
write.csv(me_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/me_mrms_noflow_wmean.csv')
...
mm_stage_summ <- read_csv('./data/final/stage_YN_response/mm_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
mm_export <- mm_tb_events %>%
  mutate(site = 'mm')

write_csv(mm_export, './data/final/tb_events/mm_tb_events.csv')
...
# 
write.csv(mm_cross,
          './data/final/stage_YN_response/cross/mm_cross_wmean.csv')
...
write.csv(mm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_tb_noflow_wmean.csv')
...
write.csv(mm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_mrms_noflow_wmean.csv')
...
mw_stage_summ <- read_csv('./data/final/stage_YN_response/mw_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
mw_export <- mw_tb_events %>%
  mutate(site = 'mw')

write_csv(mw_export, './data/final/tb_events/mw_tb_events.csv')
...
# 
write.csv(mw_cross,
          './data/final/stage_YN_response/cross/mw_cross_wmean.csv')
...
write.csv(mw_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mw_tb_noflow_wmean.csv')
...
write.csv(mw_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mw_mrms_noflow_wmean.csv')
...
ue_stage_summ <- read_csv('./data/final/stage_YN_response/ue_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
ue_export <- ue_tb_events %>%
  mutate(site = 'ue')

write_csv(ue_export, './data/final/tb_events/ue_tb_events.csv')
...
# 
write.csv(ue_cross,
          './data/final/stage_YN_response/cross/ue_cross_wmean.csv')
...
write.csv(ue_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/ue_tb_noflow_wmean.csv')
...
write.csv(ue_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/ue_mrms_noflow_wmean.csv')
...
um_stage_summ <- read_csv('./data/final/stage_YN_response/um_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
uw_export <- uw_tb_events %>%
  mutate(site = 'uw')

write_csv(uw_export, './data/final/tb_events/uw_tb_events.csv')
...
# 
write.csv(um_cross,
          './data/final/stage_YN_response/cross/um_cross_wmean.csv')
...
write.csv(um_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/um_tb_noflow_wmean.csv')
...
write.csv(um_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/um_mrms_noflow_wmean.csv')
...
```{r}
uw_stage_summ <- read_csv('./data/final/stage_YN_response/uw_stage_events.csv') %>%
  mutate(datetime_peak = with_tz(datetime_peak, tzone = "MST"),
          datetime_min = with_tz(datetime_min, tzone = "MST"))
...
# 
write.csv(uw_cross,
          './data/final/stage_YN_response/cross/uw_cross_wmean.csv')
...
write.csv(uw_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/uw_tb_noflow_wmean.csv')
...
write.csv(uw_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/uw_mrms_noflow_wmean.csv')
...
```{r}
# just bind all rows here instead
# Define the folder path
folder_path <- "./data/final/stage_YN_response/noflow_rain"
...
write.csv(rain_noflow1,
          './data/final/stage_YN_response/noflow_rain/all_noflow_wmean.csv')
...
# Define the folder path
folder_path <- "./data/final/stage_YN_response/cross"

# # List all CSV files with 'cross2' in the name
# file_list <- list.files(folder_path, pattern = "cross2.*\\.csv$", full.names = TRUE)

file_list <- list.files(folder_path, pattern = "wmean\\.csv$", full.names = TRUE)


# Function to read and add site name
read_and_add_site <- function(file) {
  site_name <- str_extract(basename(file), "^[^_]+")  # Extract text before the first '_'
  read_csv(file) %>%
...
flow <- file_list %>%
  map_dfr(read_and_add_site)

flow <- flow %>%
  mutate(site = if_else(site == 'mm' & is.na(max_stage),
                        'mm_et', 
                        site))

# filter out missing tb
flow1 <- flow %>% 
  mutate(
    condition = case_when(
      site == 'hum' &
      ...
      site == 'lum' &
        date > ymd('2023-06-11') ~ 'remove',
      site == 'aspen' &
        date < ymd('2021-05-18') ~ 'remove',
      site == 'aspen' &
        date > ymd('2021-06-28') &
        date < ymd('2021-10-7') ~ 'remove',
      site == 'aspen' &
        date > ymd('2023-09-21') ~ 'remove',
      site == 'bighorn' &
        date < ymd('2021-05-07') ~ 'remove',
      site == 'bl4' &
        date < ymd('2021-06-11') ~ 'remove',
      site == 'bl4' &
        date > ymd('2023-09-04') ~ 'remove',
      site == 'dadd' &
        date > ymd('2022-05-12') ~ 'remove',
      site == 'dry' &
        date < ymd('2021-05-18') ~ 'remove',
      site == 'michigan' &
        date > ymd('2021-10-24') ~ 'remove',
      site == 'montgomery' &
        date < ymd('2021-06-11') ~ 'remove',
      site == 'montgomery' &
        date > ymd('2023-09-19') ~ 'remove',
      site == 'me' &
        date < ymd('2021-07-19') ~ 'remove',
      site == 'me' &
        date > ymd('2021-10-21') &
        date < ymd('2022-06-16') ~ 'remove',
      site == 'me' & 
        date > ymd('2023-09-07') ~ 'remove',
      site == 'mm' &
        date < ymd('2021-09-06') ~ 'remove',
      site == 'mm' &
        date > ymd('2021-10-12') &
        date < ymd('2022-05-22') ~ 'remove',
      site == 'mm' &
        date > ymd('2022-06-07') &
        date < ymd('2022-08-10') ~ 'remove',
      site == 'mm' &
        date > ymd('2022-12-15') &
        date < ymd('2023-06-09') ~ 'remove',
      site == 'mm' & 
        date > ymd('2023-09-28') ~ 'remove',
      site == 'mw' &
        date < ymd('2021-08-20') ~ 'remove',
      site == 'mw' &
        date > ymd('2021-10-14') &
        date < ymd('2022-05-06') ~ 'remove',
      site == 'mw' &
        date > ymd('2022-07-07') &
        date < ymd('2022-08-03') ~ 'remove',
      site == 'mw' & 
        date > ymd('2023-09-19') ~ 'remove',
      site == 'ue' &
        date < ymd('2021-09-06') ~ 'remove',
      site == 'ue' & 
        date > ymd('2021-10-12') &
        date < ymd('2022-05-07') ~ 'remove',
      site == 'ue' &
        date > ymd('2023-05-01') ~ 'remove',
      site == 'mw' & 
        date > ymd('2023-06-23') ~ 'remove',
      site == 'um' & 
        date < ymd('2021-07-19') ~ 'remove',
      site == 'um' & 
        date > ymd('2023-09-07') ~ 'remove', # um stage sensor uses uw tb so have same dates
      site == 'uw' & 
        date < ymd('2021-07-19') ~ 'remove',
      site == 'uw' & 
        date > ymd('2023-09-07') ~ 'remove',
      TRUE ~ 'keep')) %>%
  filter(condition == 'keep') %>%
  filter(!(site == 'mich' & date > ymd('2022-05-31')))

write.csv(flow1, './data/final/stage_YN_response/cross/all_cross_wmean.csv')
# manully fixed mont event 90 and fixed some NA mrms that should havce been 0
# also added fire column
# mt camp event 8/1-8/3/23 for mrms needs to be manually added -- only for max dataset
# double check all missing events for tb and mrms

#flow1 <- read_csv('./data/final/stage_YN_response/cross/all_cross_max.csv')

```

# Logistic regression

etf_tb, etf_mrms, cpf_tb, cpf_mrms were manually copied from all cross csv and rain_no flow csv
...
cold_days <- read_csv('./data/prism800_airT/prism800_colddays.csv') %>%
   mutate(
    prism_date = as.Date(str_extract(dates, "\\d{8}"), format = "%Y%m%d"),
    window_start = as.POSIXct(paste0(prism_date - 1, " 05:00:00"), tz = "MST"),
    window_end   = as.POSIXct(paste0(prism_date,     " 05:00:00"), tz = "MST")
  )

flag_cold_precip <- function(df) {
  df %>%
    mutate(start_time = as.POSIXct(start_time, format = "%m/%d/%y %H:%M", tz = "MST")) %>%
    mutate(cold_precip_flag = map_lgl(seq_len(n()), function(i) {
      site_windows <- cold_days %>% filter(site == .data$site[i])
      any(.data$start_time[i] >= site_windows$window_start & 
          .data$start_time[i] < site_windows$window_end)
    }))
}
...
etf_tb <- read_csv('./data/final/stage_YN_response/etf_tb_wmean.csv') %>%
  drop_na(MI60_mmhr) %>%
  mutate(date = mdy(date)) %>%
  mutate(site = if_else(site == 'mm.et', 'mm_et', site)) %>%
...
site_kappa_values <- etf_tb %>%
  ...
  mutate(predicted_prob = predict(glm(flow ~ .data[[metric]] + lag_pwd + mean_dnbr,
...
etf_mrms <- read_csv('./data/final/stage_YN_response/etf_mrms_wmean.csv') %>%
  mutate(date = mdy(date),
...
site_kappa_values <- etf_mrms %>%
  ...
  mutate(predicted_prob = predict(glm(flow ~ .data[[metric]]
                                      + lag_pwd + mean_dnbr,
                                      data = pick(everything()), 
                                      family = 'binomial'), 
                                  type = 'response')) %>%
...
cpf_tb <- read_csv('./data/final/stage_YN_response/cpf_tb_wmean.csv') %>%
  drop_na(MI60_mmhr) %>%
  mutate(date = mdy(date)) %>%
  filter(!site %in% c('michigan', 'mich')) %>%
  ...
  mutate(site = if_else(site == 'mtcamp',
                        'mtcampus',
                        site)) %>%
  filter(!(site == 'bighorn' & date > ymd('2023-10-01'))) %>%
  filter(!(site == 'dry' & date > ymd('2023-10-01'))) %>%
  filter(!(site == 'mtcampus' & date < ymd('2021-06-01'))) %>%
  mutate(month = month(date)) %>%
  filter(month %in% c(6:9)) %>%
  flag_cold_precip(.)
...
pwd <- read_csv('./data/final_model_inputs/pwd.csv') %>%
  ...
  mutate(site = tolower(site)) %>%
  mutate(date = mdy(date)) %>%
  mutate(site = ifelse(site == 'mtcamp',
                       'mtcampus',
                       site))
...
cpf_mrms <- read_csv('./data/final/stage_YN_response/cpf_mrms_wmean.csv') %>%
  filter(!site %in% c('michigan', 'mich')) %>%
  mutate(site = if_else(site == 'mont',
                        'montgomery',
                        site)) %>%
...
# write the joined kappa to csv so don't need to run above anymore
write.csv(kappa, './data/final/stage_YN_response/kappa_mi60_wmean_updatedMar2026_TEST.csv')
...
ggplot(kappa, aes(x = kappa_value, fill = source)) +
  geom_density(alpha = 0.5) +
  theme_minimal()

##

kappa$fire <- factor(kappa$fire, levels = c("etf", "cpf"))

p1<-ggplot(kappa, aes(x = source, y = kappa_value, fill = source)) + 
  ...
  labs(y = 'MI60 kappa values', x = NULL)
##

p1

#ggsave('./figures/eventsum_wmean_kappa_boxplots.png', dpi=600)

kappa_burn <- left_join(kappa, burn, by = 'site') %>%
  mutate(burn_cat = if_else(mean_dnbr > 270, 'burn', 'unburned'))

kappa_burn$fire <- factor(kappa_burn$fire, levels = c("etf", "cpf"))

p2<-ggplot(kappa_burn, aes(x = burn_cat, y = kappa_value, fill = source)) + 
  #geom_violin(scale='width') +
...
#ggsave('./figures/eventsum_wmean_kappa_burn_boxplots.png', dpi=600)

combined_plot <- plot_grid(p1, p2, ncol = 1)
combined_plot

# ggsave('./figures/eventsum_wmean_kappa_boxplots_combine.png', 
#        combined_plot,
#        dpi=600)
...
ggplot(kappa_flip) +
  geom_point(aes(TB, MRMS, color = fire)) +
  geom_abline(slope = 1, 
              intercept = 0, 
              linetype = "dashed", 
              color = "black")
...
pBurn <-ggplot(kappa_burnOnly, aes(x = source, y = kappa_value, fill = source)) + 
  #geom_violin(scale='width') +
  geom_boxplot(position = position_dodge(0.8),
               outlier.size = 2) +
  stat_compare_means(aes(group = source),   # Perform t-test between sources within each facet
...
# # Group by site and calculate kge value for each site
# site_kge_values <- etf_tb %>%
#   group_by(site) %>%
#   #filter(n_distinct(flow) > 1) %>%  # make sure 0 and 1 are in each group
#   mutate(predicted_prob = predict(glm(flow ~ .data[[metric]] + lag_pwd,
#                                       data = pick(everything()), 
#                                       family = 'binomial'), 
#                                   type = 'response')) %>%
#   mutate(predict_use = if_else(predicted_prob < 0.5, 0, 1)) %>%
#   summarise(kge_value = confusionMatrix(factor(predict_use), factor(flow))$overall["KGE"])
...
site_kge_values <- etf_tb %>%
  ...
  mutate(predicted_prob = predict(glm(flow ~ .data[[metric]] + lag_pwd + mean_dnbr,
                                  ...
                                  type = 'response')) %>%
  summarise(
    kge_value = KGE(predicted_prob, flow))

et_tb_kge <- site_kge_values %>%
  mutate(fire = 'etf',
         source = 'tb')
...
#                                   type = 'response')) %>%
#   mutate(predict_use = if_else(predicted_prob < 0.5, 0, 1)) %>%
#   summarise(kge_value = confusionMatrix(factor(predict_use, levels = c(0, 1)), 
#                                           factor(flow, levels = c(0, 1)))$overall["KGE"])
...
kge <- bind_rows(et_tb_kge,
                   et_mrms_kge,
                   cp_tb_kge,
                   cp_mrms_kge) %>%
  mutate(source = toupper(source))

# write the joined kge to csv so don't need to run above anymore
write.csv(kge, './data/final/stage_YN_response/kge_mi60_wmean_updatedMar2026.csv')
...
kappa_elev_plot <- ggplot(kappa_elev) +
  ...
  geom_text_repel(aes(x = MRMS, y = TB, label = site),
                  size = 5,
                  color = "black") +
...
ggsave('./figures/kappa_combine2_updatelabels.png',
       width=16,
       height=10,
       dpi=600)
...
##
# by dnbr
kappa_flip <- left_join(kappa_flip, burn, by = 'site')
...
ggplot(kappa_flip) +
  ...
  geom_abline(slope = 1, 
   ...
   scale_color_continuous(type = "viridis") +
    geom_text(aes(x = MRMS, y = TB, label = site),
...
ggsave('./figures/kappa_tb_mrms_BURNmi60.png',
       dpi=600)

# by area
area <- read_csv('./data/final_model_inputs/inputs1.csv') %>%
  dplyr::select(site, area_km2) %>% 
  mutate(site = tolower(site))

kappa_flip <- left_join(kappa_flip, area, by = 'site')

area_plot <- kappa_flip %>%
  filter(!site == 'mtcampus') %>%
ggplot(.) +
  geom_point(aes(MRMS, TB, 
                 shape = fire,
...
ggsave('./figures/kappa_tb_mrms_AREAmi60.png',
       dpi=600)
