...
extra <- vect('./data/GIS/extra_mrms.shp') %>%
...
multi_rasters <- list.files("./MultiSensor/2022", pattern = ".grib2", full.names = TRUE)
...
result_folder <- "./MultiSensor_QPE_divide/extra_2022"  # Path to the folder to store the resulting rasters
...
dir <- './MultiSensor_QPE_divide/extra_2022'
...
# Path to 2 min data
folder_path <- '/Volumes/Kampf/Private/SearsM/MRMS_2023_preciprate'
...
# Set the folder path
dir <- '/Users/megansears/Documents/MRMS/SPR/2022/done_grib2'
...
result_folder <- "/Users/megansears/Documents/MRMS/MultiSensor_QPE_divide/extra_2022"
precip_folder <- "/Users/megansears/Documents/MRMS/SPR/2022/done_grib2"
multiplied_folder <- "/Users/megansears/Documents/MRMS/correctedSPR/extra_2022" # where the rasters will go
