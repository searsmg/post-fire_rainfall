...
write.csv(hum_cross,
           './data/final/stage_YN_response/cross/hum_cross_max.csv') # using mrms max extract for each catchment (touches=T)
...
write.csv(hum_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/hum_tb_noflow_max.csv')
...
write.csv(hum_mrms_noflow,
          './data/final/stage_YN_response/noflow_rain/hum_mrms_noflow_max.csv')
...
write.csv(p1_cross,
          './data/final/stage_YN_response/cross/p1_cross_max.csv')
...
write.csv(p1_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/p1_tb_noflow_max.csv')
...
write.csv(p1_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/p1_mrms_noflow_max.csv')
...
write.csv(hm_cross,
          './data/final/stage_YN_response/cross/hm_cross_max.csv')
...
write.csv(hm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/hm_tb_noflow_max.csv')
...
write.csv(hm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/hm_mrms_noflow_max.csv')
...
# 
write.csv(mpm_cross,
          './data/final/stage_YN_response/cross/mpm_cross_max.csv')
...
write.csv(mpm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mpm_tb_noflow_max.csv')
...
write.csv(mpm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mpm_mrms_noflow_max.csv')
...
# 
write.csv(mub_cross,
          './data/final/stage_YN_response/cross/mub_cross_max.csv')
...
write.csv(mub_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mub_tb_noflow_max.csv')
...
write.csv(mub_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mub_mrms_noflow_max.csv')
...
write.csv(mum_cross,
          './data/final/stage_YN_response/cross/mum_cross_max.csv')
...
write.csv(mum_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mum_tb_noflow_max.csv')
...
write.csv(mum_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mum_mrms_noflow_max.csv')
...
# 
write.csv(p2_cross,
          './data/final/stage_YN_response/cross/p2_cross_max.csv')
...
write.csv(p2_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/p2_tb_noflow_max.csv')
...
write.csv(p2_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/p2_mrms_noflow_max.csv')
...
write.csv(lm_cross,
          './data/final/stage_YN_response/cross/lm_cross_max.csv')
...
write.csv(lm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/lm_tb_noflow_max.csv')
...
write.csv(lm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/lm_mrms_noflow_max.csv')
...
# 
write.csv(lpm_cross,
          './data/final/stage_YN_response/cross/lpm_cross_max.csv')
...
write.csv(lpm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/lpm_tb_noflow_max.csv')
...
write.csv(lpm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/lpm_mrms_noflow_max.csv')
...
# 
write.csv(lum_cross,
          './data/final/stage_YN_response/cross/lum_cross_max.csv')
...
write.csv(lum_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/lum_tb_noflow_max.csv')
...
write.csv(lum_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/lum_mrms_noflow_max.csv')
...
write.csv(mm_et_cross,
          './data/final/stage_YN_response/cross/mm_et_cross_max.csv')
...
write.csv(mm_et_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_et_tb_noflow_max.csv')
...
write.csv(mm_et_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_et_mrms_noflow_max.csv')
...
write.csv(bighorn_cross,
          './data/final/stage_YN_response/cross/bighorn_cross_max.csv')
...
write.csv(bighorn_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/bighorn_tb_noflow_max.csv')
...
write.csv(bighorn_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/bighorn_mrms_noflow_max.csv')
...
# 
write.csv(bl4_cross,
          './data/final/stage_YN_response/cross/bl4_cross_max.csv')
...
write.csv(bl4_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/bl4_tb_noflow_max.csv')
...
write.csv(bl4_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/bl4_mrms_noflow_max.csv')
...
dry_cross <- dry_stage_summ %>%
  ...
  left_join(., dry_mrms_events,
            by = 'date') %>%
  slice(-c(7,8,9,12)) # check
# 
write.csv(dry_cross,
          './data/final/stage_YN_response/cross/dry_cross_max.csv')
...
write.csv(dry_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/dry_tb_noflow_max.csv')
...
write.csv(dry_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/dry_mrms_noflow_max.csv')
...
write.csv(mich_cross,
          './data/final/stage_YN_response/cross/mich_cross_max.csv')
...
write.csv(michigan_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/michigan_tb_noflow_max.csv')
...
write.csv(michigan_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/michigan_mrms_noflow_max.csv')
...
mont_cross <- mont_stage_summ %>%
  ...
  left_join(., mont_mrms_events,
            by = 'date') #%>%
  slice(-c(10,11)) %>% # FIX THIS MANUALLY bc rain tb even starts on 8/1 in all cross 2
...
write.csv(mont_cross,
          './data/final/stage_YN_response/cross/mont_cross_max.csv')
...
write.csv(mont_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mont_tb_noflow_max.csv')
...
write.csv(mont_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mont_mrms_noflow_max.csv')
...
write.csv(mtcamp_cross,
          './data/final/stage_YN_response/cross/mtcamp_cross_max.csv')
...
write.csv(mtcamp_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mtcamp_tb_noflow_max.csv')
...
write.csv(mtcamp_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mtcamp_mrms_noflow_max.csv')
...
write.csv(washout_cross,
          './data/final/stage_YN_response/cross/washout_cross_max.csv')
...
write.csv(washout_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/washout_tb_noflow_max.csv')
...
write.csv(washout_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/washout_mrms_noflow_max.csv')
...
# 
write.csv(me_cross,
          './data/final/stage_YN_response/cross/me_cross_max.csv')
...
write.csv(me_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/me_tb_noflow_max.csv')
...
write.csv(me_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/me_mrms_noflow_max.csv')
...
# 
write.csv(mm_cross,
          './data/final/stage_YN_response/cross/mm_cross_max.csv')
...
write.csv(mm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_tb_noflow_max.csv')
...
write.csv(mm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_mrms_noflow_max.csv')
...
# 
write.csv(mw_cross,
          './data/final/stage_YN_response/cross/mw_cross_max.csv')
...
write.csv(mw_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mw_tb_noflow_max.csv')
...
write.csv(mw_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mw_mrms_noflow_max.csv')
...
# 
write.csv(ue_cross,
          './data/final/stage_YN_response/cross/ue_cross_max.csv')
...
write.csv(ue_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/ue_tb_noflow_max.csv')
...
write.csv(ue_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/ue_mrms_noflow_max.csv')
...
# 
write.csv(um_cross,
          './data/final/stage_YN_response/cross/um_cross_max.csv')
...
write.csv(um_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/um_tb_noflow_max.csv')
...
write.csv(um_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/um_mrms_noflow_max.csv')
...
# 
write.csv(uw_cross,
          './data/final/stage_YN_response/cross/uw_cross_max.csv')
...
write.csv(uw_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/uw_tb_noflow_max.csv')
...
write.csv(uw_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/uw_mrms_noflow_max.csv')
...
write.csv(rain_noflow1,
          './data/final/stage_YN_response/noflow_rain/all_noflow_max.csv')
...
file_list <- list.files(folder_path, pattern = "max\\.csv$", full.names = TRUE)
...
write.csv(flow1, './data/final/stage_YN_response/cross/all_cross_max.csv')
# manully fixed mont event 90 and fixed some NA mrms that should havce been 0
# also added fire column
# mt camp event 8/1-8/3/23 for mrms needs to be manually added
...
etf_tb <- read_csv('./data/final/stage_YN_response/etf_tb_max.csv') %>%
  drop_na(MI60_mmhr) %>%
  mutate(date = mdy(date)) %>%
...
site_kappa_values <- etf_tb %>%
  ...
  mutate(predicted_prob = predict(glm(flow ~ MI60_mmhr + lag_pwd,
...
etf_mrms <- read_csv('./data/final/stage_YN_response/etf_mrms_max.csv') %>%
  mutate(date = mdy(date),
...
site_kappa_values <- etf_mrms %>%
  ...
  mutate(predicted_prob = predict(glm(flow ~ MI60_mmhr
                                      + lag_pwd,
                                      data = pick(everything()), 
                                      family = 'binomial'), 
                                  type = 'response')) %>%
...
cpf_tb <- read_csv('./data/final/stage_YN_response/cpf_tb_max.csv') %>%
  drop_na(MI60_mmhr) %>%
  mutate(date = mdy(date)) %>%
...
cpf_mrms <- read_csv('./data/final/stage_YN_response/cpf_mrms_max.csv') %>%
  filter(!site %in% c('michigan', 'mich')) %>%
  mutate(site = if_else(site == 'mont',
                        'montgomery',
                        site)) %>%
...
write.csv(kappa, './data/final/stage_YN_response/kappa_mi60_max.csv')
...
p1<-ggplot(kappa, aes(x = source, y = kappa_value, fill = source)) + 
  ...
  labs(y = 'MI30 kappa values', x = NULL)
##

p1

ggsave('./figures/mi30_max_kappa_boxplots.png', dpi=600)
...
p2<-ggplot(kappa_burn, aes(x = burn_cat, y = kappa_value, fill = source)) + 
  ...
  scale_fill_manual(values = c("#00AFBB", "#E7B800")) +
  facet_wrap(~fire, labeller = labeller(fire = new_facet_titles)) +
  labs(y = 'MI30 kappa values',
       x=NULL)

p2

ggsave('./figures/mi30_max_kappa_burn_boxplots.png', dpi=600)
...
ggsave('./figures/mi30_max_kappa_boxplots_combine.png', 
       combined_plot,
       dpi=600)
