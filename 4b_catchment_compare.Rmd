...
write.csv(hm_cross,
          './data/final/stage_YN_response/cross/hm_cross2.csv')
...
write.csv(hm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/hm_tb_noflow2.csv')
...
write.csv(hm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/hm_mrms_noflow2.csv')
...
# 
write.csv(mpm_cross,
          './data/final/stage_YN_response/cross/mpm_cross2.csv')
...
write.csv(mpm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mpm_tb_noflow2.csv')
...
write.csv(mpm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mpm_mrms_noflow2.csv')
...
# 
write.csv(mub_cross,
          './data/final/stage_YN_response/cross/mub_cross2.csv')
...
write.csv(mub_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mub_tb_noflow2.csv')
...
write.csv(mub_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mub_mrms_noflow2.csv')
...
write.csv(mum_cross,
          './data/final/stage_YN_response/cross/mum_cross2.csv')
...
write.csv(mum_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mum_tb_noflow2.csv')
...
write.csv(mum_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mum_mrms_noflow2.csv')
...
# 
write.csv(p2_cross,
          './data/final/stage_YN_response/cross/p2_cross2.csv')
...
write.csv(p2_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/p2_tb_noflow2.csv')
...
write.csv(p2_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/p2_mrms_noflow2.csv')
...
write.csv(lm_cross,
          './data/final/stage_YN_response/cross/lm_cross2.csv')
...
write.csv(lm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/lm_tb_noflow2.csv')
...
write.csv(lm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/lm_mrms_noflow2.csv')
...
# 
write.csv(lpm_cross,
          './data/final/stage_YN_response/cross/lpm_cross2.csv')
...
write.csv(lpm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/lpm_tb_noflow2.csv')
...
write.csv(lpm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/lpm_mrms_noflow2.csv')
...
# 
write.csv(lum_cross,
          './data/final/stage_YN_response/cross/lum_cross2.csv')
...
write.csv(lum_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/lum_tb_noflow2.csv')
...
write.csv(lum_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/lum_mrms_noflow2.csv')
...
write.csv(mm_et_cross,
          './data/final/stage_YN_response/cross/mm_et_cross2.csv')
...
write.csv(mm_et_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_et_tb_noflow2.csv')
...
write.csv(mm_et_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_et_mrms_noflow2.csv')
...
write.csv(bighorn_cross,
          './data/final/stage_YN_response/cross/bighorn_cross2.csv')
...
write.csv(bighorn_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/bighorn_tb_noflow2.csv')
...
write.csv(bighorn_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/bighorn_mrms_noflow2.csv')
...
# 
write.csv(bl4_cross,
          './data/final/stage_YN_response/cross/bl4_cross2.csv')
...
write.csv(bl4_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/bl4_tb_noflow2.csv')
...
write.csv(bl4_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/bl4_mrms_noflow2.csv')
...
# 
write.csv(dry_cross,
          './data/final/stage_YN_response/cross/dry_cross2.csv')
...
write.csv(dry_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/dry_tb_noflow2.csv')
...
write.csv(dry_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/dry_mrms_noflow2.csv')
...
write.csv(mich_cross,
          './data/final/stage_YN_response/cross/mich_cross2.csv')
...
write.csv(michigan_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/michigan_tb_noflow2.csv')
...
write.csv(michigan_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/michigan_mrms_noflow2.csv')
...
write.csv(mont_cross,
          './data/final/stage_YN_response/cross/mont_cross2.csv')
...
write.csv(mont_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mont_tb_noflow2.csv')
...
write.csv(mont_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mont_mrms_noflow2.csv')
...
write.csv(mtcamp_cross,
          './data/final/stage_YN_response/cross/mtcamp_cross2.csv')
...
write.csv(mtcamp_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mtcamp_tb_noflow2.csv')
...
write.csv(mtcamp_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mtcamp_mrms_noflow2.csv')
...
write.csv(washout_cross,
          './data/final/stage_YN_response/cross/washout_cross2.csv')
...
write.csv(washout_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/washout_tb_noflow2.csv')
...
write.csv(washout_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/washout_mrms_noflow2.csv')
...
# 
write.csv(me_cross,
          './data/final/stage_YN_response/cross/me_cross2.csv')
...
write.csv(me_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/me_tb_noflow2.csv')
...
write.csv(me_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/me_mrms_noflow2.csv')
...
# 
write.csv(mm_cross,
          './data/final/stage_YN_response/cross/mm_cross2.csv')
...
write.csv(mm_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_tb_noflow2.csv')
...
write.csv(mm_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mm_mrms_noflow2.csv')
...
# 
write.csv(mw_cross,
          './data/final/stage_YN_response/cross/mw_cross2.csv')
...
write.csv(mw_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/mw_tb_noflow2.csv')
...
write.csv(mw_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/mw_mrms_noflow2.csv')
...
# 
write.csv(ue_cross,
          './data/final/stage_YN_response/cross/ue_cross2.csv')
...
write.csv(ue_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/ue_tb_noflow2.csv')
...
write.csv(ue_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/ue_mrms_noflow2.csv')
...
# 
write.csv(um_cross,
          './data/final/stage_YN_response/cross/um_cross2.csv')
...
write.csv(um_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/um_tb_noflow2.csv')
...
write.csv(um_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/um_mrms_noflow2.csv')
...
# 
write.csv(uw_cross,
          './data/final/stage_YN_response/cross/uw_cross2.csv')
...
write.csv(uw_tb_noflow, 
          './data/final/stage_YN_response/noflow_rain/uw_tb_noflow2.csv')
...
write.csv(uw_mrms_noflow, 
          './data/final/stage_YN_response/noflow_rain/uw_mrms_noflow2.csv')
...
write.csv(flow1, './data/final/stage_YN_response/cross/all_cross2.csv')
# manully fixed mont event 90 and fixed some NA mrms that should havce been 0
# also added fire column

flow1 <- read_csv('./data/final/stage_YN_response/cross/all_cross2.csv')
...
etf_tb <- read_csv('./data/final/stage_YN_response/etf_tb2.csv') %>%
  drop_na(MI60_mmhr) %>%
  mutate(date = mdy(date)) %>%
...
site_kappa_values <- etf_tb %>%
  ...
  mutate(predicted_prob = predict(glm(flow ~ MI30_mmhr + lag_pwd,
...
etf_mrms <- read_csv('./data/final/stage_YN_response/etf_mrms2.csv') %>%
  mutate(date = mdy(date),
...
cpf_tb <- read_csv('./data/final/stage_YN_response/cpf_tb2.csv') %>%
  drop_na(MI60_mmhr) %>%
  mutate(date = mdy(date)) %>%
...
cpf_mrms <- read_csv('./data/final/stage_YN_response/cpf_mrms2.csv') %>%
  filter(!site %in% c('michigan', 'mich')) %>%
  mutate(site = if_else(site == 'mont',
                        'montgomery',
                        site)) %>%
...
write.csv(kappa, './data/final/stage_YN_response/kappa_final_v2.csv')
...
ggsave('./figures/eventsum_2_kappa_boxplots.png', dpi=600)
...
ggsave('./figures/eventP_2_kappa_burn_boxplots.png', dpi=600)
...
ggsave('./figures/eventP_2_kappa_burn_boxplots_combine.png', 
       combined_plot,
       dpi=600)
...
# bring in catchments
catch <- st_read('./data/GIS/catchments_all/catchments_all_lidar.shp')
