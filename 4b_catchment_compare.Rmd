...
##########################################################################
kappa <- read_csv('./data/final/stage_YN_response/kappa_eventsum_wmean.csv')
...
ggplot(kappa_elev) +
  ...
  geom_abline(slope = 1, 
   ...
   scale_color_gradientn(colours = terrain.colors(15)) +
    geom_text(aes(x = TB, y = MRMS, label = site),  # Add site label
            size = 3, vjust = -1, hjust = -0.1,  # Adjust positioning as needed
            color = "black") 
