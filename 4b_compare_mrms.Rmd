...
# p1_a<-ggplot(kappa, aes(x = source, y = kappa_value, fill = source)) + 
...
#   scale_fill_manual(values = c("#00AFBB", "#E7B800")) +
#   facet_wrap(~fire, labeller = labeller(fire = new_facet_titles)) +
#   labs(y = 'Kappa value', x = NULL)
# 
# 
# p1_a
# 
# p2_a <-ggplot(kappa_burn, aes(x = burn_cat, y = kappa_value, fill = source)) + 
#   geom_dotplot(binwidth = .05,
#                 binaxis='y',
#                stackdir ='center',
#                position = position_dodge(0.9)) +
