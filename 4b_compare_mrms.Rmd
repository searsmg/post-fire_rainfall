...
aspen_stage <- aspen %>%
  ...
  mutate(Stage_fix = if_else(datetime >= ymd_hms('2023-01-01 14:00:00',
                             ...
                             Stage_fix + 6,
                             Stage_fix)) %>% # annual adjustment
  filter(!datetime == ymd_hms('2023-05-25 10:00:00', tz = 'MST'))
...
bighorn_stage$stage_corr_cm=ifelse(bighorn_stage$datetime >ymd_hms('2021-05-07 12:00:00', tz = 'MST'),
                                   bighorn_stage$stage_corr_cm+3,bighorn_stage$stage_corr_cm)

##### new adjustments under this line #####

#offset adjust for download
bighorn_stage$stage_corr_cm=ifelse(bighorn_stage$datetime >ymd_hms('2022-05-03 14:00:00', tz = 'MST'),
                                   bighorn_stage$stage_corr_cm+1.5,bighorn_stage$stage_corr_cm)

#offset adjust for download
bighorn_stage$stage_corr_cm=ifelse(bighorn_stage$datetime >ymd_hms('2022-05-19 12:45:00', tz = 'MST'),
                                   bighorn_stage$stage_corr_cm+2,bighorn_stage$stage_corr_cm)

#offset adjust for download
bighorn_stage$stage_corr_cm=ifelse(bighorn_stage$datetime >ymd_hms('2022-07-26 13:15:00', tz = 'MST'),
                                   bighorn_stage$stage_corr_cm-5.5,bighorn_stage$stage_corr_cm)

#offset adjust between 2022 -2023
bighorn_stage$stage_corr_cm=ifelse(bighorn_stage$datetime >ymd_hms('2022-12-22 05:00:00', tz = 'MST'),
                                    bighorn_stage$stage_corr_cm+1.5,bighorn_stage$stage_corr_cm)

#bed elevation adjustment after storm peak
bighorn_stage$stage_corr_cm=ifelse(bighorn_stage$datetime >ymd_hms('2023-06-08 09:30:00', tz = 'MST'),
                                   bighorn_stage$stage_corr_cm-3.3,bighorn_stage$stage_corr_cm)

#offset adjust for download
bighorn_stage$stage_corr_cm=ifelse(bighorn_stage$datetime >ymd_hms('2023-06-16 10:15:00', tz = 'MST'),
                                   bighorn_stage$stage_corr_cm-0.5,bighorn_stage$stage_corr_cm)

# #offset adjust for download
bighorn_stage$stage_corr_cm=ifelse(bighorn_stage$datetime >ymd_hms('2023-06-27 10:45:00', tz = 'MST'),
                                    bighorn_stage$stage_corr_cm-1.2,bighorn_stage$stage_corr_cm)

#bed appears to aggrade after rain on 8/24/23, move stage down
bighorn_stage$stage_corr_cm=ifelse(bighorn_stage$datetime >ymd_hms('2023-08-24 13:45:00', tz = 'MST'),
                                   bighorn_stage$stage_corr_cm-1,bighorn_stage$stage_corr_cm)

#delete sensor spikes
bighorn_stage$stage_corr_cm = ifelse(bighorn_stage$datetime == ymd_hms('2022-05-19 12:30:00', tz = 'MST'),
                                     NA, bighorn_stage$stage_corr_cm)

bighorn_stage$stage_corr_cm = ifelse(bighorn_stage$datetime == ymd_hms('2023-06-27 11:00:00', tz = 'MST'),
                                     NA, bighorn_stage$stage_corr_cm)
...
bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2021-06-11 12:30:00', tz = 'MST'),
...
#offset adjust for download
bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2021-08-06 08:30:00', tz = 'MST'),
...
#delete sensor spike
bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime == ymd_hms('2021-08-06 08:45:00', tz = 'MST'),
  NA,
  bl4_stage$Stage_corr_cm
)
...
#offset adjust for download
bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2021-08-27 09:00:00', tz = 'MST'),
...
bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2021-10-25 11:00:00', tz = 'MST'),
...
bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2022-06-10 14:00:00', tz = 'MST'),
...
#delete sensor spike
bl4_stage$Stage_corr_cm = ifelse((
  bl4_stage$datetime >= ymd_hms('2022-07-08 10:45:00', tz = 'MST') &
    bl4_stage$datetime <= ymd_hms('2022-07-08 11:00:00', tz = 'MST')
),
NA,
bl4_stage$Stage_corr_cm
)
...
bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2022-08-10 10:00:00', tz = 'MST'),
  bl4_stage$Stage_corr_cm - 1,
  bl4_stage$Stage_corr_cm
)

bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2022-09-16 12:15:00', tz = 'MST'),
  bl4_stage$Stage_corr_cm - 1,
  bl4_stage$Stage_corr_cm
)

bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2022-09-21 16:15:00', tz = 'MST'),
  bl4_stage$Stage_corr_cm - 1,
  bl4_stage$Stage_corr_cm
)

bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2022-09-29 13:00:00', tz = 'MST'),
  bl4_stage$Stage_corr_cm - 1,
  bl4_stage$Stage_corr_cm
)
# #2022-2023 year adjustment
bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2023-01-01 01:00:00', tz = 'MST'),
...
bl4_stage$Stage_corr_cm = ifelse(
  bl4_stage$datetime > ymd_hms('2023-06-26 12:00:00', tz = 'MST'),
...
bl4_stage$Stage_corr_cm = ifelse((
  bl4_stage$datetime > ymd_hms('2022-05-28 00:00:00', tz = 'MST') &
    bl4_stage$datetime <= ymd_hms('2022-06-10 14:00:00', tz = 'MST')
),
NA,
bl4_stage$Stage_corr_cm
...
#delete sensor spike
bl4_stage$Stage_corr_cm = ifelse((
  bl4_stage$datetime >= ymd_hms('2023-08-03 00:00:00', tz = 'MST') &
    bl4_stage$datetime <= ymd_hms('2023-08-03 00:45:00', tz = 'MST')
),
NA,
bl4_stage$Stage_corr_cm
)
...
dry_stage_pt_before<- dry_stage %>%
  filter(datetime < ymd_hms('2023-07-13 10:45:00', tz = 'MST'))
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-04-01 09:30:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-04-03 20:00:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-04-19 12:00:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-05-06 12:45:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-05-18 11:30:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-05-23 00:00:00', tz = 'MST'),
  dry_stage$stage_corr_cm - 1,
  dry_stage$stage_corr_cm
)
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-06-26 00:00:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-06-30 11:30:00', tz = 'MST'),
  dry_stage$stage_corr_cm - 8,
  dry_stage$stage_corr_cm
)
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-07-20 15:00:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-07-26 15:00:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-07-30 12:00:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2021-08-16 09:00:00', tz = 'MST'),
...
#2021-2022 year adjustment
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2022-02-02 12:00:00', tz = 'MST'),
  dry_stage$stage_corr_cm - 1,
  dry_stage$stage_corr_cm
)
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2022-05-12 11:00:00', tz = 'MST'),
  dry_stage$stage_corr_cm + 1,
  dry_stage$stage_corr_cm
)
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2022-05-25 11:00:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms("2022-07-06 14:25:00", tz = 'MST'),
  dry_stage$stage_corr_cm - 8,
  dry_stage$stage_corr_cm
)
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms("2022-07-18 11:45:00", tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse((
  dry_stage$datetime > ymd_hms("2022-08-05 09:05:00", tz = 'MST') &
    dry_stage$datetime < ymd_hms("2022-08-15 21:30:00", tz = 'MST')
),
NA,
dry_stage$stage_corr_cm
)
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2022-08-15 21:00:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2022-08-29 10:00:00', tz = 'MST'),
  dry_stage$stage_corr_cm + 6,
  dry_stage$stage_corr_cm
)
...
#2022-2023 year adjustment
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2023-05-04 10:00:00', tz = 'MST'),
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2023-05-05 19:30:00', tz = 'MST'),
  dry_stage$stage_corr_cm - 5,
  dry_stage$stage_corr_cm
)
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2023-06-06 14:25:00', tz = 'MST'),
  dry_stage$stage_corr_cm - 1.5,
  dry_stage$stage_corr_cm
)
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime > ymd_hms('2023-06-11 15:50:00', tz = 'MST'),
  dry_stage$stage_corr_cm - 1.5,
  dry_stage$stage_corr_cm
)
...
dry_stage$stage_corr_cm = ifelse(
  dry_stage$datetime == ymd_hms('2023-07-13 10:50:00', tz = 'MST'),
  NA,
  dry_stage$stage_corr_cm
)
...
dry_stage <- dry_stage %>%
  filter(!(
    datetime > ymd_hms("2022-02-02 07:00:00", tz = 'MST') &
      datetime < ymd_hms("2022-03-20 08:55:00", tz = 'MST')
  )) %>%
  filter(!(
    datetime > ymd_hms("2022-11-12 16:00:00", tz = 'MST') &
      datetime < ymd_hms("2023-05-04 12:00:00", tz = 'MST')
  ))
...
mich <- read_csv('./data/stage/michigan_stage.csv') %>%
  mutate(datetime2 = mdy_hm(dt_use, tz = 'MST'),
...
mtcamp <- read_csv('./data/stage/mtcampus_stage_composite.csv') %>%
  mutate(datetime = mdy_hm(Date_time, tz = 'MST')) %>%
...
write.csv(lm_cross,
          './data/final/stage_YN_response/cross/lm_cross.csv')
...
bighorn_tb_events <- bighorn_tb_events %>%
  ...
  mutate(start_time = force_tz(start_time, tz = 'MST'),
         end_time = force_tz(end_time, tz = 'MST')) %>%
  select(duration_hr, 
         MI30_mmhr, 
         MI60_mmhr,
         start_time, 
...
site_kappa_values <- etf_tb %>%
  ...
  mutate(predicted_prob = predict(glm(flow ~ MI30_mmhr + mean_dnbr + lag_pwd,
...
etf_mrms <- read_csv('./data/final/stage_YN_response/etf_mrms.csv') %>%
  mutate(date = mdy(date),
         start_time = mdy_hm(start_time, tz ='MST')) %>%
  filter(start_time > ymd_hms('2022-06-20 11:00:00', tz = 'MST')) %>%
  mutate(
    condition = case_when(
      site == 'hum' &
        start_time > ymd_hms('2022-08-04 11:16:00', tz = 'MST') ~ 'remove',
      site == 'p1' &
        start_time > ymd_hms('2022-07-12 08:36:00', tz = 'MST') &
        start_time < ymd_hms('2022-07-21 16:00:00', tz = 'MST') ~ 'remove',
      site == 'p1' &
        start_time > ymd_hms('2023-07-21 23:57:00', tz = 'MST') ~ 'remove',
      site == 'lpm' &
        start_time > ymd_hms('2022-10-18 10:23:00', tz = 'MST') &
        start_time < ymd_hms('2023-05-24 13:20:00', tz = 'MST') ~ 'remove',
      site == 'lpm' &
        start_time > ymd_hms('2023-06-11 16:55:00', tz = 'MST') ~ 'remove',
      TRUE ~ 'keep'
    )
  ) %>%
...
cpf_mrms <- read_csv('./data/final/stage_YN_response/cpf_mrms.csv') %>%
  ...
  mutate(
    condition = case_when(
      site == 'aspen' &
        start_time < ymd_hms('2021-05-18 14:30:00', tz = 'MST') ~ 'remove',
      site == 'aspen' &
        start_time > ymd_hms('2021-06-28 11:56:00', tz = 'MST') &
        start_time < ymd_hms('2021-10-7 15:00:00', tz = 'MST') ~ 'remove',
      site == 'aspen' &
        start_time > ymd_hms('2023-09-21 12:45:00', tz = 'MST') ~ 'remove',
      site == 'bighorn' &
        start_time < ymd_hms('2021-05-07 11:20:00', tz = 'MST') ~ 'remove',
      site == 'bl4' &
        start_time < ymd_hms('2021-06-11 13:00:00', tz = 'MST') ~ 'remove',
      site == 'bl4' &
        start_time > ymd_hms('2023-09-04 14:15:00', tz = 'MST') ~ 'remove',
      site == 'dadd' &
        start_time > ymd_hms('2022-05-12 15:00:00', tz = 'MST') ~ 'remove',
      site == 'dry' &
        start_time < ymd_hms('2021-05-18 11:15:00', tz = 'MST') ~ 'remove',
      site == 'michigan' &
        start_time > ymd_hms('2021-10-24 11:15:00', tz = 'MST') ~ 'remove',
      site == 'montgomery' &
        start_time < ymd_hms('2021-06-11 10:00:00', tz = 'MST') ~ 'remove',
      site == 'montgomery' &
        start_time > ymd_hms('2023-09-19 19:00:00', tz = 'MST') ~ 'remove',
      site == 'me' &
        start_time < ymd_hms('2021-07-19 15:45:00', tz = 'MST') ~ 'remove',
      site == 'me' &
        start_time > ymd_hms('2021-10-21 14:00:00', tz = 'MST') &
        start_time < ymd_hms('2022-06-16 11:00:00', tz = 'MST') ~ 'remove',
      site == 'me' & 
        start_time > ymd_hms('2023-09-07 15:45:00', tz = 'MST') ~ 'remove',
      site == 'mm' &
        start_time < ymd_hms('2021-09-06 13:30:00', tz = 'MST') ~ 'remove',
      site == 'mm' &
        start_time > ymd_hms('2021-10-12 15:35:00', tz = 'MST') &
        start_time < ymd_hms('2022-05-22 10:00:00', tz = 'MST') ~ 'remove',
      site == 'mm' &
        start_time > ymd_hms('2022-06-07 01:25:00', tz = 'MST') &
        start_time < ymd_hms('2022-08-10 10:00:00', tz = 'MST') ~ 'remove',
      site == 'mm' &
        start_time > ymd_hms('2022-12-15 19:55:00', tz = 'MST') &
        start_time < ymd_hms('2023-06-09 09:15:00', tz = 'MST') ~ 'remove',
      site == 'mm' & 
        start_time > ymd_hms('2023-09-28 13:10:00', tz = 'MST') ~ 'remove',
      site == 'mw' &
        start_time < ymd_hms('2021-08-20 10:50:00', tz = 'MST') ~ 'remove',
      site == 'mw' &
        start_time > ymd_hms('2021-10-14 12:42:00', tz = 'MST') &
        start_time < ymd_hms('2022-05-06 12:00:00', tz = 'MST') ~ 'remove',
      site == 'mw' &
        start_time > ymd_hms('2022-07-06 12:10:00', tz = 'MST') &
        start_time < ymd_hms('2022-08-03 10:15:00', tz = 'MST') ~ 'remove',
      site == 'mw' & 
        start_time > ymd_hms('2023-09-19 15:05:00', tz = 'MST') ~ 'remove',
      site == 'ue' &
        start_time < ymd_hms('2021-09-06 13:00:00', tz = 'MST') ~ 'remove',
      site == 'ue' &
        start_time > ymd_hms('2021-10-12 13:17:00', tz = 'MST') &
        start_time < ymd_hms('2022-05-07 12:00:00', tz = 'MST') ~ 'remove',
      site == 'mw' & 
        start_time > ymd_hms('2023-05-22 11:33:00', tz = 'MST') ~ 'remove',
      site == 'um' & 
        start_time < ymd_hms('2021-07-19 14:00:00', tz = 'MST') ~ 'remove',
      site == 'um' & 
        start_time > ymd_hms('2023-09-07 14:05:00', tz = 'MST') ~ 'remove', # um stage sensor uses uw tb so have same dates
      site == 'uw' & 
        start_time < ymd_hms('2021-07-19 14:00:00', tz = 'MST') ~ 'remove',
      site == 'uw' & 
        start_time > ymd_hms('2023-09-07 14:05:00', tz = 'MST') ~ 'remove',
      TRUE ~ 'keep')) %>%
  filter(condition == 'keep') 
...
site_kappa_values <- cpf_mrms %>%
  group_by(site) %>%
  #filter(n_distinct(flow) > 1, n() > 5) %>% 
  mutate(predicted_prob = predict(glm(flow ~ event_sum_mm + lag_pwd + mean_dnbr,
                                      data = pick(everything()), 
                                      family = 'binomial'), 
                                  type = 'response')) %>%
  mutate(predict_use = if_else(predicted_prob < 0.5, 0, 1)) %>%
